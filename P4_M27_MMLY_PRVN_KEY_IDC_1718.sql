create or replace PROCEDURE            "P4_M27_MMLY_PRVN_KEY_IDC_1718"
...
IS
    /*--------------------------------------------------------------------------
     * PROGRAM ID    : P4_M27_MMLY_PRVN_KEY_IDC_1718
     * PROGRAM NAME  : A program for insert data to TM27_MMLY_PRVN_KEY_IDC_A
     * SOURCE TABLE  : TB03_G32_006_TTGS_A
                       TM27_MMLY_PCF_KEY_IDC_A
                       TM26_MMLY_AST_QAL_A
                       TM23_MMLY_INCM_EXP_A
                       TM24_MMLY_FUND_SRC_USG_A
     * TARGET TABLE  : TM27_MMLY_PRVN_KEY_IDC_A
     * PROGRAMER     : HIEU
    ...
    v_program_id              VARCHAR2(100) DEFAULT 'P4_M27_MMLY_PRVN_KEY_IDC_1718' ;
...
BEGIN
    ...
    BEGIN
          ...
          DELETE
            FROM TM27_MMLY_PRVN_KEY_IDC_A T1
    ...
    BEGIN
          ...
          INSERT INTO TM27_MMLY_PRVN_KEY_IDC_A
          (   BAS_YM
             ,PRVN_CD
             ,KPI_TYP_CD
             ,AGT_METH_CD
          ...
          (SELECT A.BAS_YM,
           ...
           FROM   (SELECT T1.BAS_YM,
                  ...
                  ) A INNER JOIN (SELECT T1.BAS_YM, T3.PRVN_CD, SUM(TOT_AST_AMT) AS PRVN_AST_AMT
                                  FROM   TM27_MMLY_PCF_KEY_IDC_A T1 INNER JOIN TM00_PCF_D T2
                                                                            ON T1.PCF_ID = T2.PCF_ID
                                                                    INNER JOIN TM00_LOC_D T3
                                                                            ON T2.LOC_ID = T3.LOC_ID
          ...
          (SELECT T1.BAS_YM,
           ...
           SELECT XX.BAS_YM,
                  ...
                  0     AS RNK_NUM,
                  NULL  AS PCF_ID,
                  ROUND(AVG(YY.FIXED_ASSET_RTO), 2) AS AGT_VAL
           FROM   (SELECT T1.BAS_YM, T3.PRVN_CD
                   FROM   FROM_TM27_MMLY_PCF_KEY_IDC_A T1 INNER JOIN TM00_PCF_D T2
                                                                  ON T1.PCF_ID = T2.PCF_ID
                                                          INNER JOIN TM00_LOC_D T3
                   ...
                   GROUP BY T1.BAS_YM, T3.PRVN_CD
                                          ...
                                          C.PRVN_CD,
                                          ROUND(AVG(A.PRFBL_AST_VS_TOT_AST_RTO), 2) AS FIXED_ASSET_RTO
                                   FROM   TM27_MMLY_PCF_KEY_IDC_A A INNER JOIN TM00_PCF_D B
                                                                            ON B.PCF_ID = A.PCF_ID
                                                                    INNER JOIN TM00_LOC_D C
                                                                            ON B.LOC_ID = C.LOC_ID
           ...
           SELECT BAS_YM,
                  ...
                  0     AS RNK_NUM,
                  NULL  AS PCF_ID,
                  FIXED_ASSET_RTO AS AGT_VAL
           FROM   (SELECT XX.BAS_YM,
                          XX.PRVN_CD,
                          ROUND(AVG(YY.FIXED_ASSET_RTO), 2) AS FIXED_ASSET_RTO
                   FROM   (SELECT T1.BAS_YM, T3.PRVN_CD
                           FROM   FROM_TM27_MMLY_PCF_KEY_IDC_A T1 INNER JOIN TM00_PCF_D T2
                                                                          ON T1.PCF_ID = T2.PCF_ID
                                                                  INNER JOIN TM00_LOC_D T3
          ...
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_001
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_002
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_003
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_004
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_005
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_006
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_007
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_008
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_009
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_010
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_058
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_066
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_069
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_070
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_071
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_088
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_090
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_091
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_092
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_093
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_094
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_133
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_135
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_136
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_137
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_138
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_141
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_142
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_143
          UNION ALL
          SELECT BAS_YM, PRVN_CD, KPI_TYP_CD, AGT_METH_CD, TOP_BTOM_TYP_CD, RNK_NUM, PCF_ID, AGT_VAL, SYSTIMESTAMP FROM FROM_KPI_TYP_144
          ;
